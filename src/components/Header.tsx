...
import { Search, ShoppingCart, User, Menu, Heart, LogOut, Shield } from "lucide-react";
                  ...
                  <div className="pt-4 border-t">
                    {user ? (
                      <>
                        ...
                        {isAdmin && (
                          <Link to="/admin" className="text-lg font-medium py-2 px-4 rounded-lg hover:bg-secondary block flex items-center gap-2">
